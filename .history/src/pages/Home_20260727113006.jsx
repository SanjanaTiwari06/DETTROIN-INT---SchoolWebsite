...
const quickLinks = [
  { to: "/academics", image:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT950AtboLkEIqluXh2xFH-Jmf212CaIzjqhXHcuG7nW8BS_TXTsuG_SR8&s=10", title: "Academics", text: "CBSE, IGCSE, and the Junior School pathway.", icon: "bi-journal-bookmark" },
            ...
            {quickLinks.map((q) => (
              <div className="col-md-4" key={q.to}>
                <Link to={q.to} className="vvs-quicklink">
                 <img src={q.image} alt="" className="vvs-pillar-bg" loading="lazy" aria-hidden="true" sizes="fu" />
